...
const {triggerMouseEvent, triggerClickEvent, buildDragEvents, buildWheelEvent, buildWheelPlusShiftEvent} = require("./event-helpers");
...
describe("Tabs package main", function() {
  ...
  describe(".activate()", () =>
    it("appends a tab bar all existing and new panes", function() {
...
describe("TabBarView", function() {
  ...
  describe("when the mouse is moved over the tab bar", () =>
    it("fixes the width on every tab", function() {
  ...
  describe("when the active pane item changes", () =>
    it("highlights the tab for the new active pane item", function() {
  ...
  describe("when a new item is added to the pane", function() {
    ...
    return describe("when addNewTabsAtEnd is set to false in package settings", () =>
  ...
  describe("when a tab's close icon is clicked", () =>
    it("destroys the tab's item on the pane", function() {
      jasmine.attachToDOM(tabBar.element); // Remove after Atom 1.2.0 is released
  ...
  describe("when a tab item's title changes", () =>
    it("updates the title of the item's tab", function() {
  ...
  describe("when two tabs have the same title", () =>
    it("displays the long title on the tab if it's available from the item", function() {
      item1.title = "Old Man";
  ...
  describe("when a tab item's modified status changes", () =>
    it("adds or removes the 'modified' class to the tab based on the status", function() {
  ...
  describe("when a pane item moves to a new index", function() {
    ...
    describe("when addNewTabsAtEnd is set to true in package settings", () =>
      it("updates the order of the tabs to match the new item order", function() {
        atom.config.set("tabs.addNewTabsAtEnd", true);
  ...
  describe("context menu commands", function() {
    ...
    describe("when tabs:close-other-tabs is fired", () =>
      it("closes all other tabs except the active tab", function() {
        triggerClickEvent(tabBar.tabForItem(item2).element, {which: 3});
    ...
    describe("when tabs:close-tabs-to-right is fired", () =>
      it("closes only the tabs to the right of the active tab", function() {
        pane.activateItem(editor1);
    ...
    describe("when tabs:close-tabs-to-left is fired", () =>
      it("closes only the tabs to the left of the active tab", function() {
        pane.activateItem(editor1);
        triggerClickEvent(tabBar.tabForItem(editor1).element, {which: 3});
    ...
    describe("when tabs:close-all-tabs is fired", () =>
      it("closes all the tabs", function() {
    ...
    describe("when tabs:close-saved-tabs is fired", () =>
      it("closes all the saved tabs", function() {
    ...
    describe("when tabs:split-up is fired", () =>
      it("splits the selected tab up", function() {
        triggerClickEvent(tabBar.tabForItem(item2).element, {which: 3});
    ...
    describe("when tabs:split-down is fired", () =>
      it("splits the selected tab down", function() {
        triggerClickEvent(tabBar.tabForItem(item2).element, {which: 3});
        expect(atom.workspace.getCenter().getPanes().length).toBe(1);
    ...
    describe("when tabs:split-left is fired", () =>
      it("splits the selected tab to the left", function() {
        triggerClickEvent(tabBar.tabForItem(item2).element, {which: 3});
        expect(atom.workspace.getCenter().getPanes().length).toBe(1);
    ...
    describe("when tabs:split-right is fired", () =>
      it("splits the selected tab to the right", function() {
        triggerClickEvent(tabBar.tabForItem(item2).element, {which: 3});
        expect(atom.workspace.getCenter().getPanes().length).toBe(1);
    ...
    return describe("when tabs:open-in-new-window is fired", function() {
      ...
      return describe("from the command palette", () =>
  ...
  describe("command palette commands", function() {
    ...
    return describe("when pane:close is fired", () =>
      it("destroys all the tabs within the pane", function() {
  ...
  describe("dragging and dropping tabs", function() {
    describe("when a tab is dragged within the same pane", function() {
      describe("when it is dropped on tab that's later in the list", () =>
        it("moves the tab and its item, shows the tab's item, and focuses the pane", function() {
          expect(tabBar.getTabs().map(tab => tab.element.textContent)).toEqual(["Item 1", "sample.js", "Item 2"]);
      ...
      describe("when it is dropped on itself", () =>
        it("doesn't move the tab or item, but does make it the active item and focuses the pane", function() {
          expect(tabBar.getTabs().map(tab => tab.element.textContent)).toEqual(["Item 1", "sample.js", "Item 2"]);
          expect(pane.getItems()).toEqual([item1, editor1, item2]);
          expect(pane.getActiveItem()).toBe(item2);
          spyOn(pane, 'activate');
      ...
      return describe("when it is dropped on the tab bar", () =>
        it("moves the tab and its item to the end", function() {
          expect(tabBar.getTabs().map(tab => tab.element.textContent)).toEqual(["Item 1", "sample.js", "Item 2"]);
          expect(pane.getItems()).toEqual([item1, editor1, item2]);
          expect(pane.getActiveItem()).toBe(item2);
          spyOn(pane, 'activate');
    ...
    describe("when a tab is dragged to a different pane", function() {
      ...
      return describe("when addNewTabsAtEnd is set to true in package settings", () =>
        it("moves the dragged tab to the desired index in the new pane", function() {
          atom.config.set("tabs.addNewTabsAtEnd", true);
          expect(tabBar.getTabs().map(tab => tab.element.textContent)).toEqual(["Item 1", "sample.js", "Item 2"]);
          expect(pane.getItems()).toEqual([item1, editor1, item2]);
          expect(pane.getActiveItem()).toBe(item2);
    ...
    describe("when a tab is dragged over a pane item", function() {
      ...
      return describe("when the pane is empty", () =>
        it("moves the tab to the target pane", function() {
    ...
    describe("when a tab is dragged out of application", () =>
      it("should carry the file's information", function() {
  ...
  describe("when the tab bar is double clicked", () =>
    it("opens a new empty editor", function() {
  ...
  describe("when the mouse wheel is used on the tab bar", function() {
    describe("when tabScrolling is true in package settings", function() {
      ...
      describe("when the mouse wheel scrolls up and shift key is pressed", () =>
        it("does not change the active tab", function() {
          expect(pane.getActiveItem()).toBe(item2);
      ...
      return describe("when the mouse wheel scrolls down and shift key is pressed", () =>
        it("does not change the active tab", function() {
          expect(pane.getActiveItem()).toBe(item2);
          tabBar.element.dispatchEvent(buildWheelPlusShiftEvent(-120));
          return expect(pane.getActiveItem()).toBe(item2);
    ...
    return describe("when tabScrolling is false in package settings", function() {
      ...
      return describe("when the mouse wheel scrolls down one unit", () =>
        it("does not change the active tab", function() {
          expect(pane.getActiveItem()).toBe(item2);
          tabBar.element.dispatchEvent(buildWheelEvent(-120));
          return expect(pane.getActiveItem()).toBe(item2);
  ...
  describe("when alwaysShowTabBar is true in package settings", function() {
    ...
    describe("when 2 tabs are open", () =>
      it("shows the tab bar", function() {
        expect(pane.getItems().length).toBe(3);
        return expect(tabBar).not.toHaveClass('hidden');
      })
    );

    return describe("when 1 tab is open", () =>
      it("shows the tab bar", function() {
        expect(pane.getItems().length).toBe(3);
  ...
  if ((atom.workspace.buildTextEditor().isPending != null) || (atom.workspace.getActivePane().getActiveItem != null)) {
    ...
    describe("when tab's pane item is pending", function() {
      ...
      describe("when opening a new tab", () =>
        it("adds tab with class 'temp'", function() {
          editor1 = null;
      ...
      describe("when tabs:keep-pending-tab is triggered on the pane", () =>
        it("terminates pending state on the tab's item", function() {
          editor1 = null;
          waitsForPromise(() => atom.workspace.open('sample.txt', {pending: true}).then(o => editor1 = o));
      ...
      describe("when editing a file in pending state", () =>
        it("makes the item and tab permanent", function() {
          editor1 = null;
          waitsForPromise(() =>
            atom.workspace.open('sample.txt', {pending: true}).then(function(o) {
              editor1 = o;
      ...
      describe("when saving a file", () =>
        it("makes the tab permanent", function() {
          editor1 = null;
          waitsForPromise(() =>
            atom.workspace.open(path.join(temp.mkdirSync('tabs-'), 'sample.txt'), {pending: true}).then(function(o) {
              editor1 = o;
              pane.activateItem(editor1);
              return editor1.save();
            })
      ...
      return describe("when dragging a pending tab to a different pane", () =>
        it("makes the tab permanent in the other pane", function() {
          editor1 = null;
          waitsForPromise(() => atom.workspace.open('sample.txt', {pending: true}).then(o => editor1 = o));
